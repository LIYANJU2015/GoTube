...
package com.playtube.player.gui.fragments.preferences;
...
import com.playtube.player.businessobjects.YouTube.ValidateYouTubeAPIKey;
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
		if(key != null) {
			if (key.equals(getString(R.string.pref_key_default_tab))) {
				...
				GoTubeApp.setFeedUpdateInterval(interval);
			}*/
		}
	}
