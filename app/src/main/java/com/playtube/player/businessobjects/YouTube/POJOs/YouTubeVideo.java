...
package com.playtube.player.businessobjects.YouTube.POJOs;
...
import com.playtube.player.businessobjects.FileDownloaderHelper;
import com.playtube.player.businessobjects.Logger;
import com.playtube.player.businessobjects.YouTube.VideoStream.ParseStreamMetaData;
...
public class YouTubeVideo implements Serializable {
	...
	public YouTubeVideo(Video video) {
		...
		if (video.getStatistics() != null) {
			...
			this.viewsCount = String.format(GoTubeApp.getStr(R.string.views),
	...
	private void setIsLiveStream() {
		...
		if (duration.equals("0:00")) {
			isLiveStream = true;
			duration = GoTubeApp.getStr(R.string.LIVE);
	...
	private Set<String> getPreferredLanguages() {
		return GoTubeApp.getPreferenceManager().getStringSet(GoTubeApp.getStr(R.string.pref_key_preferred_languages), defaultPrefLanguages);
	}
