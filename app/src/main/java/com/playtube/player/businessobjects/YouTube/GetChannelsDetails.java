...
package com.playtube.player.businessobjects.YouTube;
...
import com.playtube.player.businessobjects.YouTube.POJOs.YouTubeAPI;
import com.playtube.player.businessobjects.YouTube.POJOs.YouTubeAPIKey;
...
public class GetChannelsDetails {
	...
	public List<YouTubeChannel> getYouTubeChannels(List<String> channelIdsList, boolean isUserSubscribed, boolean shouldCheckForNewVideos) throws IOException {
		String  bannerType = GoTubeApp.isTablet() ? "bannerTabletHdImageUrl" : "bannerMobileHdImageUrl";
