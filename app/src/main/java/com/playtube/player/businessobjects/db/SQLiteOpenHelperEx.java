...
package com.playtube.player.businessobjects.db;
...
//	}
	...
	public String getDatabasePath() {
		return GoTubeApp.getContext().getDatabasePath(getDatabaseName()).getPath();
	}
	...
	public File getDatabaseDirectory() {
		return GoTubeApp.getContext().getDatabasePath(getDatabaseName()).getParentFile();
	}
