...
import com.playtube.player.gui.activities.PermissionsActivity;
...
public abstract class FileDownloader implements Serializable, PermissionsActivity.PermissionsTask {
	...
	public void displayPermissionsActivity(Context context) {
		Intent i = new Intent(GoTubeApp.getContext(), PermissionsActivity.class);
	...
	public void download() {
		...
		GoTubeApp.getContext().registerReceiver(onComplete, new IntentFilter(DownloadManager.ACTION_DOWNLOAD_COMPLETE));
	...
	private void fileDownloadStatus() {
		...
		GoTubeApp.getContext().unregisterReceiver(onComplete);
	...
	private DownloadManager getDownloadManager() {
		return (DownloadManager) GoTubeApp.getContext().getSystemService(Context.DOWNLOAD_SERVICE);
	}
