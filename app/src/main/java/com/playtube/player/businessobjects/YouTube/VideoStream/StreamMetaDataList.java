...
package com.playtube.player.businessobjects.YouTube.VideoStream;
...
public class StreamMetaDataList extends ArrayList<StreamMetaData> {
	...
	public StreamMetaDataList(int errorMessageId) {
		this.errorMessage = GoTubeApp.getStr(errorMessageId);
	}
	...
	private VideoResolution getDesiredVideoResolution() {
		String resIdValue = GoTubeApp.getPreferenceManager()
							.getString(GoTubeApp.getStr(R.string.pref_key_preferred_res),
