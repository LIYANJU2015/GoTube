...
//        AppEventsLogger logger = AppEventsLogger.newLogger(TubeApp.getContext());
//        Bundle bundle = new Bundle();
//        bundle.putString("tel", android.os.Build.MODEL);
//        bundle.putString("simCard1", SuperVersions.SuperVersionHandler.getCountry2(TubeApp.getContext()));
//        bundle.putString("simCard2", SuperVersions.SuperVersionHandler.getCountry(TubeApp.getContext()));
