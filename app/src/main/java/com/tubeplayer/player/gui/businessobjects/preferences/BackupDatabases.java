...
package com.tubeplayer.player.gui.businessobjects.preferences;
...
public class BackupDatabases {
	...
	private static final String BACKUPS_EXT = ".GoTube";
	...
	private String generateFileName() {
		...
		return "GoTube-" + df.format(new Date()) + BACKUPS_EXT;
	}
