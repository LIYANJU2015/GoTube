package com.tubeplayer.player.gui.player.controller;
...
import com.tubeplayer.player.gui.player.util.BatteryReceiver;
import com.tubeplayer.player.gui.player.widget.MarqueeTextView;
...
//        moreMenu.setOnClickListener(this);
        ...
        urlErrorView = controllerView.findViewById(R.id.url_error_view);
    }

    public void showUrlError(String message) {
        urlErrorView.setVisibility(View.VISIBLE);
        urlErrorView.setText(message);
