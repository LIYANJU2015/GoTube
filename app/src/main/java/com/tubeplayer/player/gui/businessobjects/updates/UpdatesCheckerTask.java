...
package com.tubeplayer.player.gui.businessobjects.updates;
...
public class UpdatesCheckerTask extends AsyncTaskParallel<Void, Void, UpdatesChecker> {
	...
	/** If set to true, it will display the "GoTube is up to date" message.  */
	 ...
	 * @param displayUpToDateMessage    If set to true, it will display the "GoTube is up to date"
