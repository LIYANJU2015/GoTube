...
import free.studio.tube.businessobjects.YouTube.Tasks.GetSubscriptionVideosTaskListener;
...
public class FeedUpdaterService extends Service implements GetSubscriptionVideosTaskListener {
	...
	public void onAllChannelVideosFetched() {
		if(newVideosFetched.size() > 0) {
			...
			Notification notification = new NotificationCompat.Builder(this, GoTubeApp.NEW_VIDEOS_NOTIFICATION_CHANNEL)
			...
			notificationManager.notify(GoTubeApp.NEW_VIDEOS_NOTIFICATION_CHANNEL_ID, notification);
