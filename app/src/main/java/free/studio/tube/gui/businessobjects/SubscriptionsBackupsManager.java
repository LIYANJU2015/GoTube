...
import free.studio.tube.businessobjects.YouTube.Tasks.GetSubscriptionVideosTask;
import free.studio.tube.businessobjects.db.SubscriptionsDb;
import free.studio.tube.gui.businessobjects.adapters.ImportSubscriptionsAdapter;
import free.studio.tube.gui.businessobjects.adapters.SubsAdapter;
import free.studio.tube.gui.businessobjects.preferences.BackupDatabases;
import free.studio.tube.gui.fragments.SubscriptionsFeedFragment;
...
public class SubscriptionsBackupsManager {
	...
	private void displayFilePicker(final boolean importDb) {
		...
		properties.extensions = importDb ? new String[]{"GoTube"} : new String[]{"xml"};
